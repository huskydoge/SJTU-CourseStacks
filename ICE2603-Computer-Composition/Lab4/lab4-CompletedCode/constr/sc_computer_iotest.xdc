...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets {computer_main/cpu/rf/dram_i_382_0}]
# condition and setting the following XDC constraint on any one of the nets in the loop: 'set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets <myHier/myNet>]'. One net in the loop is . Please evaluate your design. cells in the loop are: computer_main/imem/dram_i_2, 
